...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(core.choices.execution_thread_count_range),
		minimum = core.choices.execution_thread_count_range[0],
		maximum = core.choices.execution_thread_count_range[-1]
	)
