...
from core.typing import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = core.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(core.choices.system_memory_limit_range),
		minimum = core.choices.system_memory_limit_range[0],
		maximum = core.choices.system_memory_limit_range[-1],
