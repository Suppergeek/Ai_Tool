...
from core.typing import JobStatus
...
def update_job_status_checkbox_group(job_statuses : List[JobStatus]) -> gradio.CheckboxGroup:
	job_statuses = job_statuses or core.choices.job_statuses
