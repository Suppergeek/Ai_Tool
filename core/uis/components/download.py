...
import core.choices
from core import content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, state_manager, voice_extractor, wording
from core.filesystem import list_directory
from core.processors.core import get_processors_modules
from core.typing import DownloadProvider
...
def render() -> None:
	...
	DOWNLOAD_PROVIDERS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		...
		choices = core.choices.download_providers,
...
def update_download_providers(download_providers : List[DownloadProvider]) -> gradio.CheckboxGroup:
	...
	download_providers = download_providers or core.choices.download_providers
