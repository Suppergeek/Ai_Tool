...
import core.choices
from core.typing import ExecutionDevice, ExecutionProvider, ValueAndUnit
...
def create_inference_execution_providers(execution_device_id : str, execution_providers : List[ExecutionProvider]) -> List[Any]:
	...
	for execution_provider in execution_providers:
		if execution_provider == 'cuda':
			inference_execution_providers.append((core.choices.execution_provider_set.get(execution_provider),
			{
	...
	if 'cpu' in execution_providers:
		inference_execution_providers.append(core.choices.execution_provider_set.get('cpu'))
