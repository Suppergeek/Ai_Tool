...
import core.jobs.job_manager
import core.jobs.job_store
import core.processors.core as processors
from core import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, wording
from core.common_helper import create_int_metavar
...
from core.face_masker import create_occlusion_mask, create_static_box_mask
from core.face_selector import find_similar_faces, sort_and_filter_faces
from core.face_store import get_reference_faces
from core.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from core.processors import choices as processors_choices
from core.processors.live_portrait import create_rotation, limit_expression
from core.processors.typing import ExpressionRestorerInputs
from core.processors.typing import LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw
from core.program_helper import find_argument_group
from core.thread_helper import conditional_thread_semaphore, thread_semaphore
from core.typing import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from core.vision import get_video_frame, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		core.jobs.job_store.register_step_keys([ 'expression_restorer_model','expression_restorer_factor' ])
