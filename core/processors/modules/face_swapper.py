...
from core.face_masker import create_occlusion_mask, create_region_mask, create_static_box_mask
from core.face_selector import find_similar_faces, sort_and_filter_faces, sort_faces_by_order
from core.face_store import get_reference_faces
from core.filesystem import filter_image_paths, has_image, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from core.model_helper import get_static_model_initializer
from core.processors import choices as processors_choices
from core.processors.pixel_boost import explode_pixel_boost, implode_pixel_boost
from core.processors.typing import FaceSwapperInputs
from core.program_helper import find_argument_group
from core.thread_helper import conditional_thread_semaphore
from core.typing import ApplyStateItem, Args, DownloadScope, Embedding, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from core.vision import read_image, read_static_image, read_static_images, unpack_resolution, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		core.jobs.job_store.register_step_keys([ 'face_swapper_model', 'face_swapper_pixel_boost' ])
...
def forward_swap_face(source_face : Face, crop_vision_frame : VisionFrame) -> VisionFrame:
	...
	if has_execution_provider('coreml') and model_type in [ 'ghost', 'uniface' ]:
		face_swapper.set_providers([ core.choices.execution_provider_set.get('cpu') ])
