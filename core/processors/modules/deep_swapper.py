...
from core.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
...
from core.filesystem import in_directory, is_image, is_video, list_directory, resolve_relative_path, same_file_extension
from core.processors import choices as processors_choices
from core.processors.typing import DeepSwapperInputs, DeepSwapperMorph
from core.program_helper import find_argument_group
from core.thread_helper import thread_semaphore
from core.typing import ApplyStateItem, Args, DownloadScope, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from core.vision import conditional_match_frame_color, read_image, read_static_image, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		core.jobs.job_store.register_step_keys([ 'deep_swapper_model', 'deep_swapper_morph' ])
