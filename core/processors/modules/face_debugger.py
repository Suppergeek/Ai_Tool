...
from core import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, process_manager, state_manager, wording
...
from core.filesystem import in_directory, same_file_extension
from core.processors import choices as processors_choices
from core.processors.typing import FaceDebuggerInputs
from core.program_helper import find_argument_group
from core.typing import ApplyStateItem, Args, Face, InferencePool, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		core.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
