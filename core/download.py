...
from core.filesystem import get_file_size, is_file, remove_file
from core.hash_helper import validate_hash
from core.typing import DownloadProvider, DownloadSet
...
def ping_download_provider(download_provider : DownloadProvider) -> bool:
	download_provider_value = core.choices.download_provider_set.get(download_provider)
