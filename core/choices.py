...
download_provider_set : DownloadProviderSet =\
{
	'github':
	{
		...
		'path': '/core/core-assets/releases/download/{base_name}/{file_name}'
	},
	'huggingface':
	{
		'url': 'https://huggingface.co',
		'path': '/core/{base_name}/resolve/main/{file_name}'
	}
}
